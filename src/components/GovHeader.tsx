        ...
        <header className="bg-white dark:bg-zinc-950 border-b border-gray-100 dark:border-zinc-800 shadow-sm sticky top-0 z-[100] transition-all duration-300">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center px-4 md:px-8 py-3 gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm md:text-base font-bold text-[#084D8E] dark:text-[#66b3ff] leading-tight">
            ...
            {/* Row 2: Navigation & App Title */}
            <div className="bg-[#f8fafc] dark:bg-zinc-900/50 border-t border-gray-100 dark:border-zinc-800/50 px-4 md:px-8 py-3">
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    <div className="flex items-center gap-4">
                        <button
                            onClick={onMenuToggle}
                            className="p-2 text-[#005A9C] dark:text-[#66b3ff] hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-xl transition-all"
                        >
                    ...
                    <div className="flex items-center gap-2">
                        <span className="text-[10px] md:text-xs font-bold text-gray-400 uppercase tracking-widest">Unidade Escolar:</span>
                        <div className="px-3 py-1 bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-lg shadow-sm">
                            <span className="text-xs md:text-sm font-black text-[#005A9C] dark:text-[#66b3ff] uppercase">
                                {schoolName || 'SMEDU'}
                            </span>
                        </div>
                    </div>
