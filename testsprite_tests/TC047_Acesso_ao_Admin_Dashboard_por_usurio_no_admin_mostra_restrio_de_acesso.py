...
async def run_test():
    ...
    try:
        ...
        # -> Type the non-admin email into the email field (#email) and password into the password field, then click Entrar to attempt login.
        ...
        await expect(frame.locator('text=Contate o administrador').first).to_be_visible(timeout=3000)
